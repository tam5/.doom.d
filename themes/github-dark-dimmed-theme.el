;;; doom-github-dark-dimmed-theme.el --- inspired by GitHub Theme for VS Code -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added
;; Author
;; Maintainer
...
(def-doom-theme doom-github-dark-dimmed
  ...
  ((bg         '("#282c34" "black"       "black"  ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if doom-github-dark-dimmed-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if doom-github-dark-dimmed-brighter-comments dark-cyan base5) 0.25))
   (constants      violet)
   (functions      magenta)
   (keywords       blue)
   (methods        cyan)
   ...
   (modeline-bg              (if doom-github-dark-dimmed-brighter-modeline
                                 (doom-darken blue 0.45)
                               (doom-darken bg-alt 0.1)))
   (modeline-bg-alt          (if doom-github-dark-dimmed-brighter-modeline
  ...
  (((line-number &override) :foreground base4)
   ...
   (mode-line-emphasis :foreground (if doom-github-dark-dimmed-brighter-modeline base8 highlight))
   ...
   ;;;; doom-modeline
   (doom-modeline-bar :background (if doom-github-dark-dimmed-brighter-modeline modeline-bg highlight))
